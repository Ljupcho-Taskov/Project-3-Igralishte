...
const ProductDetailsPage: React.FC<Props> = ({ product, allProductsData }) => {
  ...
  const discountAmount =
    (product.discountProcent / 100) * parseInt(product.price);
  const discountedPrice = parseInt(product.price) - discountAmount;
  useEffect(() => {
          ...
          <div className="col-12 d-flex flex-column py-3">
            ...
            <div className="row pt-2">
              {product.images?.map((imageData, index) => {
                ...
                return (
                  <div className="col-3" key={imageData.id}>
                    <img
            ...
            <div>
              <p
                className={`pPrice my-3 ${
                  product.discount ? "red-alert line-through" : ""
                }`}
              >
                {product.price} ден.
              </p>
              <p className="pPrice mb-3">{discountedPrice} ден.</p>
              <p className="d-flex flex-column align-items-end p-fixed">
                {!isAddedToCart ? (
                  <span
                    onClick={handleAddToCart}
                    className="spanCart pointer mb-2"
                  >
              ...
              {!isAddedToCart ? (
                <>
                  <button
                    ...
                    onClick={handleAddToCart}
                  >
                    <span className="buttonPriceSpan">Додади во кошничка</span>
                  </button>
                </>
              ) : (
                <>
